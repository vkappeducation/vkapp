        ...
        <asp:Table ID="Table1" runat="server" Height="130px" Width="61px" CellPadding="5" CellSpacing="5" BorderStyle="None" ForeColor="#414141">
            ...
            <asp:TableRow runat="server" BorderStyle="Double" BorderColor="#333333" BorderWidth="2px" ClientIDMode="Static">
                ...
                <asp:TableCell ID="Cell1" runat="server" RowSpan="20" VerticalAlign="Top">
                    ...
                    <br />
                  <br />
                    <asp:Label ID="Label3" runat="server" Text="Задайте нужные вам страну, вид и направление и получите необходимые источники финансирования с дедлайнами подачи заявки.

" Width="500"></asp:Label>
                     <br />
                  <br />
                    <asp:Label ID="Label9" runat="server" Text="Обращаем ваше внимание, что сроки приема документов на некоторые стипендии в этом году уже прошли – но они будут доступны в следующем!
