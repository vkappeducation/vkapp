    ...
    <section class="featured">
        <div class="content-wrapper">
            ...
            <p>
                ...
                На странице приводятся <mark>видеоматериалы, учебники и образцы кода</mark> , позволяющие лучшим образом использовать 
                ASP.NET. По всем вопросам об ASP.NET обращайтесь на 
